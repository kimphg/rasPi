...
QT_MOC_LITERAL(4, 28, 6) // "doWork"
    ...
    "Worker\0deleteObject\0\0thingy\0doWork"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Worker::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::deleteObject)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Worker::deleteObject(QObject * _t1)
{
